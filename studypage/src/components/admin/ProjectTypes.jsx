...
function ProjectTypes() {
  ...
  const handleCreateProjectType = async () => {
    ...
    try {
      const response = await axios.post('https://studypage.onrender.com/project-types', {
        name: newProjectType
      });
  ...
  const handleUpdateProjectType = async (id) => {
    ...
    try {
      const response = await axios.put(`https://studypage.onrender.com/project-types/${id}`, {
        name: editName
      });
      setProjectTypes(
  ...
  const handleDeleteProjectType = async (id) => {
    try {
      await axios.delete(`https://studypage.onrender.com/project-types/${id}`);
