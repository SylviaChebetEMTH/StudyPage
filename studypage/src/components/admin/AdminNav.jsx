...
const AdminPage = () => {
  ...
  return (
    <div className="flex flex-col  h-screen bg-gray-900">
      {/* Upper Navigation */}
      <nav className="bg-gray-900 px-4 md:px-6 py-3 flex flex-wrap justify-between items-center border-b border-gray-700">
        {/* Left Section */}
        <div className="flex items-center space-x-6">
          <div className="text-yellow-500 font-bold text-2xl">
            <Link to="/">Study<span className="text-white">Page</span></Link>
        ...
        <div
          className={`${
            isMenuOpen ? 'block' : 'hidden'
          } fixed inset-0 top-16 bg-gray-900 z-50 md:static md:flex md:items-center md:justify-between md:w-auto md:space-x-4 md:inset-auto`}
        >
          <div className="flex flex-col p-4 md:p-0 md:flex-row md:space-x-8 text-center md:items-center">
            <div className="relative text-white py-2 md:py-0">
              <Link to="/admin/adminreply">
                <FontAwesomeIcon icon={faBell} className="text-xl hover:text-yellow-400" />
              </Link>
          ...
          {/* Right Section */}
          <div className="flex flex-col p-4 md:p-0 md:flex-row md:items-center md:space-x-4 text-center py-4 md:py-0">
            <div className="text-white py-2 md:py-0">
              <FontAwesomeIcon icon={faWallet} className="text-xl" />
              <span className="ml-1">$0.00</span>
            </div>
      ...
      {/* Lower Navigation */}
      <nav className="bg-gray-800 border-b border-gray-700 px-2 md:px-6 py-2 overflow-x-auto">
        {/* Wrapper for centered content */}
        <div className="flex justify-between items-center">
          {/* Navigation items */}
          <ul className="flex space-x-2 md:space-x-6 whitespace-nowrap">
            <li className="text-gray-300 hover:text-yellow-400 cursor-pointer px-2 py-1">
              <NavLink to="/admin" end className={({isActive}) => isActive ? "text-yellow-400 font-bold" : ""}>
                Dashboard
              </NavLink>
          ...
          {location.pathname === '/adminchat' && (
            <button 
              onClick={toggleSidebar}
              className="bg-gray-700 hover:bg-gray-600 text-white px-2 md:px-3 py-1 rounded transition-colors duration-200 flex-shrink-0 ml-2"
            >
      ...
      {location.pathname === '/adminchat' && (
        <div className="flex flex-1 overflow-hidden">
          {/* Sidebar for conversations - Improved mobile handling */}
          {sidebarVisible && (
          ...
          <div 
            className={`
              ...
              fixed md:static left-0 top-0 h-full z-50 md:z-auto pt-16 md:pt-0
              w-3/4 max-w-xs md:max-w-none md:w-80 bg-gray-800 border-r border-gray-700
              transition-all duration-300 md:translate-x-0
            `}
          >
            <AdminSidebar onSelectConversation={(conv) => {
          ...
          <div className="flex-1 flex flex-col h-full overflow-hidden">
            {selectedConversation ? (
              ...
              <div className="flex items-center justify-center h-full bg-gray-900">
                <div className="text-center p-8 max-w-md">
                  <svg 
                    className="w-16 h-16 mx-auto mb-6 text-gray-600" 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
                  ...
                  <p className="text-gray-400 mb-6">
                    {sidebarVisible || window.innerWidth >= 768 ? 
                      "Select a conversation from the sidebar to view and respond to messages." :
                      "Tap the 'Show' button to view conversations."
                    }
                  </p>
                  <div className="flex items-center justify-center">
                    <div className="w-2 h-2 rounded-full bg-blue-500 animate-ping mr-2"></div>
