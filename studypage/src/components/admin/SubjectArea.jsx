...
function SubjectArea() {
  ...
  const handleCreateSubject = async () => {
    ...
    try {
      const response = await axios.post('https://studypage-76hu.onrender.com/subjects', {
        name: newSubject
      });
  ...
  const handleUpdateSubject = async (id) => {
    ...
    try {
      const response = await axios.put(`https://studypage-76hu.onrender.com/subjects/${id}`, {
        name: editName
      });
      setSubjects(
  ...
  const handleDeleteSubject = async (id) => {
    try {
      await axios.delete(`https://studypage-76hu.onrender.com/subjects/${id}`);
