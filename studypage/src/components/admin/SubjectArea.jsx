...
function SubjectArea() {
  ...
  const fetchSubjects = async () => {
    try {
      const response = await axios.get('https://backendstudypage.onrender.comsubjects');
  ...
  const handleCreateSubject = async () => {
    ...
    try {
      const response = await axios.post('https://backendstudypage.onrender.com/subjects', {
        name: newSubject
      });
  ...
  const handleUpdateSubject = async (id) => {
    ...
    try {
      const response = await axios.put(`https://backendstudypage.onrender.com/subjects/${id}`, {
        name: editName
      });
      setSubjects(
  ...
  const handleDeleteSubject = async (id) => {
    try {
      await axios.delete(`https://backendstudypage.onrender.com/subjects/${id}`);
