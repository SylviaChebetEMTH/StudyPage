...
//                 </div>
//                 {/* Project Types */}
//                 <div className="flex flex-col items-center bg-pink-500 text-white rounded-lg shadow-md p-6">
...
//                 </div>
//                 {/* Subjects */}
//                 <div className="flex flex-col items-center bg-orange-500 text-white rounded-lg shadow-md p-6">
