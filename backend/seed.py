...
# from models import User, Expert, Service, ProjectRequest, ProjectType
...
#     services = [
#         Service(title='Essays', price=10.00, unit='per page', project_type=project_types[0]),
#         Service(title='Admissions Essay', price=15.00, unit='per page', project_type=project_types[0]),
#         Service(title='PowerPoint Presentation', price=8.00, unit='per slide', project_type=project_types[1]),
#         Service(title='Research Paper', price=20.00, unit='per page', project_type=project_types[0]),
#         Service(title='Assignments', price=12.00, unit='per page', project_type=project_types[0]),
#         Service(title='Homework', price=12.00, unit='per page', project_type=project_types[0]),
#         Service(title='Speech', price=10.00, unit='per page', project_type=project_types[0]),
#         Service(title='Book Reviews', price=10.00, unit='per page', project_type=project_types[0]),
#         Service(title='Coursework', price=15.00, unit='per page', project_type=project_types[0]),
#         Service(title='Personal Statement', price=18.00, unit='per page', project_type=project_types[0]),
#         Service(title='PhD Dissertation', price=30.00, unit='per page', project_type=project_types[0]),
#         Service(title='Thesis', price=25.00, unit='per page', project_type=project_types[0]),
#         Service(title='Case Study', price=22.00, unit='per page', project_type=project_types[1]),
#         Service(title='Term Paper', price=15.00, unit='per page', project_type=project_types[0]),
#         Service(title='Lab Report', price=20.00, unit='per page', project_type=project_types[1]),
#         Service(title='Editing', price=5.00, unit='per page', project_type=project_types[0]),
#         Service(title='Proofreading', price=4.00, unit='per page', project_type=project_types[0]),
#         Service(title='Rewrite', price=7.00, unit='per page', project_type=project_types[0]),
#     ]
...
#     db.session.add_all([user1, admin1, *project_types, expert1, expert2, *services, request1, request2])
